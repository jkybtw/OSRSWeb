...
/* harmony import */ var ng_animate_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ng-animate-scroll */ "./node_modules/ng-animate-scroll/fesm2015/ng-animate-scroll.js");
...
let ContactsComponent = class ContactsComponent {
    ...
    onMaterialChecked(name, checked) {
        if (checked === true) {
    ...
    onReplacementChecked(name, checked) {
        if (checked === true) {
    ...
    filterBaseCurves(array) {
        ...
        let idx = 0;
        while (idx < array.length) {
            const value = array[idx]['BaseCurve'].toString();
            if (value === 'undefined') {
                idx++;
                continue;
            }
